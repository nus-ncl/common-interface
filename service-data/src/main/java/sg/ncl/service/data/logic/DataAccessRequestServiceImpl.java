...
public class DataAccessRequestServiceImpl implements DataAccessRequestService {
    ...
    public DataAccessRequest createRequest(Long id, String reason, Claims claims) {
        ...
        try {
            ...
            mailService.send(null, "NCL Testbed Ops <testbed-ops@ncl.sg>", to, "Pending Dataset Access Request", msgText, false, cc, null);
    ...
    public DataAccessRequest approveRequest(Long did, Long rid, Claims claims) {
        ...
        try {
            ...
            mailService.send(null,"NCL Testbed Ops <testbed-ops@ncl.sg>", to, "Dataset Access Request Approved", msgText, false, cc, null);
            log.debug("Email sent: {}", msgText);
        } catch (IOException | TemplateException e) {
            log.warn("{}", e);
        }
