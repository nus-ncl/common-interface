...
public void registerOldUserJoinTeamTest() throws Exception {
   ...
   mockServer.expect(requestTo(properties.getJoinProject()))
    ...
    when(registrationService.registerRequestToJoinTeam(anyString(),any(Team.class)))
            .thenReturn(regInfo);
...
public void approveTeam() throws Exception {
    ...
    public void joinRequest() throws Exception {
        ...
        when(registrationService.rejectJoinRequest(anyString(), anyString(), any(User.class)))
                .thenReturn(predefinedResultJson.toString());
    ...
    public void testGetDeterUid() throws Exception {
        ...
        when(registrationService.getDeterUid(anyString()))
                .thenReturn(deterUid);
