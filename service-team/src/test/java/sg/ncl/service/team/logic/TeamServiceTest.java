...
public class TeamServiceTest extends AbstractTest {
    ...
    public void testSaveTeam() {
        TeamEntity createdTeam = TestUtil.getTeamEntity();
    ...
    public void testGetAllTeams() throws Exception {
        ...
        for (int i = 0; i < 3; i++) {
            teamInfoList.add(teamService.createTeam(TestUtil.getTeamEntity()));
        }
    ...
    public void testUpdateTeamNullField() {
        TeamEntity team = TestUtil.getTeamEntity();
    ...
    public void testAddUserToTeam() throws Exception {
        TeamEntity team = TestUtil.getTeamEntity();
        TeamMemberInfo teamMemberInfo = TestUtil.getTeamMemberInfo(MemberType.MEMBER);
        Team createdTeam = teamService.createTeam(team);
    ...
    public void testIsTeamOwnerGood() throws Exception {
        TeamEntity team = TestUtil.getTeamEntity();
        TeamMemberInfo teamMemberInfo = TestUtil.getTeamMemberInfo(MemberType.OWNER);
        Team createdTeam = teamService.createTeam(team);
    ...
    public void changeTeamStatusGood() throws Exception {
        Team one = TestUtil.getTeamEntity();
        TeamMemberInfo owner = TestUtil.getTeamMemberInfo(MemberType.OWNER);
    ...
    public void removeTeamMemberTeamNotFound() throws Exception {
        teamService.removeMember(RandomStringUtils.randomAlphanumeric(20), TestUtil.getTeamMemberInfo(MemberType.MEMBER));
    }
    ...
    public void removeTeamMemberGood() throws Exception {
        Team one = TestUtil.getTeamEntity();
        Team createdTeam = teamService.createTeam(one);
        TeamMemberInfo teamMemberOne = TestUtil.getTeamMemberInfo(MemberType.OWNER);
        TeamMemberInfo teamMemberTwo = TestUtil.getTeamMemberInfo(MemberType.MEMBER);
