...
public class CredentialsInfoTest {
    ...
    private final CredentialsInfo credentialsInfo = new CredentialsInfo(userId, username, password, CredentialsStatus.ACTIVE, new HashSet<>(Arrays.asList(Role.ADMIN, Role.USER)));
